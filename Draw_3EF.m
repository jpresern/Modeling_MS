...
%   Function computes and draws I-R curves of the desensitization tests
%   for multiple conditioning amplitudes (Hao Fig3). At the same time plots
...
%%%%%%%%%%%%%  Drawing adaptive shift fits Hao Fig 3EFGHI: Draws the x50 (um) amplitudes against conditioning time (ms)

...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Data that will be fitted are stored in Test_ExpementalData.mat
...
function Modeling_MS(Project_in)
%%
...
copyfile(filename(inputDir,{inputDir},'Modeling_MS.m'),...
...
Modeling_MS_Report(Project,horzcat(Project,'_Results_',num2str(MaxInd+1)));
